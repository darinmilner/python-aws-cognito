...
from ..ClientApp.app.core.config import env_vars

region = env_vars.AWS_REGION
cognito_user_pool_id = env_vars.AWS_COGNITO_USER_POOL_ID
cognito_app_client_id = env_vars.AWS_COGNITO_APP_CLIENT_ID
...
class CognitoJWTAuthorizer:
    ...
    def __call__(self, authorization: Annotated[str | None, Header()] = None):
        ...
        print(authorization)
        print(self.region)
        print(self.cognito_app_client_id)
